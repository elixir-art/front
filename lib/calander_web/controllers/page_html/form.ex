defmodule CalanderWeb.PageHtml.Form do
  ...
  def render(assigns) do
    ...
    <form id="form" phx-hook="Form">
      <div class="fixed top-[50%] left-[50%] transform -translate-x-[50%] -translate-y-[50%]">
        <div class="py-[32px] px-[46px] shadow-2xl border border-gray-200 rounded-lg ">
          ...
          <section id="section-4" class="hidden">
            <div class="flex justify-center min-h-[268px]">
              <div class="flex flex-wrap flex-col items-center justify-center w-[70%]">
                ...
                <button
                  class="rounded-full py-[15px] px-[30px] bg-blue-700"
                  type="submit"
                  id="submit-btn"
                >
